...
{
    public class ArtPol_IntegrationShoperRCFIG : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Postacie";

        private readonly string NamePart = "Postacie";
        ...
        internal override string IdPrefix => "RCFIG";
