...
{
    public class ArtPol_IntegrationShoperRMCIT : IntegratorShoperBase
    {
        private string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Abstrakcje - różne / Miasta i architektura";

        private readonly string NamePart = "Abstrakcje - różne / Miasta i architektura";
        ...
        internal override string IdPrefix => "RMCIT";
