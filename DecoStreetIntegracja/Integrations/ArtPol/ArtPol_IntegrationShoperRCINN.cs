...
{
    public class ArtPol_IntegrationShoperRCINN : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Architektura / Inne";

        private readonly string NamePart = "Architektura / Inne";
        ...
        internal override string IdPrefix => "RCINN";
