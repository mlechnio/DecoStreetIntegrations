...
{
    public class ArtPol_IntegrationShoperRMMTS : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Kopie Mistrzów  / Henri Matisse";

        private readonly string NamePart = "Kopie Mistrzów / Henri Matisse";
        ...
        internal override string IdPrefix => "RMMTS";
