...
{
    public class ArtPol_IntegrationShoperRCNY : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Architektura / Nowy Jork";

        private readonly string NamePart = "Architektura / Nowy Jork";
        ...
        internal override string IdPrefix => "RCNY";
