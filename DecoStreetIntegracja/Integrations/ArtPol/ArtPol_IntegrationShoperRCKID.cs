...
{
    public class ArtPol_IntegrationShoperRCKID : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Inne / Dziecięce";

        private readonly string NamePart = "Inne / Dziecięce";
        ...
        internal override string IdPrefix => "RCKID";
