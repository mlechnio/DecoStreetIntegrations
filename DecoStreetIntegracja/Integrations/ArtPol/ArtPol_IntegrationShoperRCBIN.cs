...
{
    public class ArtPol_IntegrationShoperRCBIN : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Kwiaty / Bukiety i martwa natura";

        private readonly string NamePart = "Kwiaty / Bukiety i martwa natura";
        ...
        internal override string IdPrefix => "RCBIN";
