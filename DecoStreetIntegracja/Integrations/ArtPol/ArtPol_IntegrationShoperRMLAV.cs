...
{
    public class ArtPol_IntegrationShoperRMLAV : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Pejzaże - Różne / Pola lawendowe";

        private readonly string NamePart = "Pejzaże - Różne / Pola lawendowe";
        ...
        internal override string IdPrefix => "RMLAV";
