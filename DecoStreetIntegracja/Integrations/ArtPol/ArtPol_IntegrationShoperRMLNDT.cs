...
{
    public class ArtPol_IntegrationShoperRMLNDT : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Pejzaż tradycyjny";

        private readonly string NamePart = "Pejzaż tradycyjny";
        ...
        internal override string IdPrefix => "RMLNDT";
