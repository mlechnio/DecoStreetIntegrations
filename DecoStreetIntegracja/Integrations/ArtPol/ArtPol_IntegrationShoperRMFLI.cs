...
{
    public class ArtPol_IntegrationShoperRMFLI : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Kwiaty  inne";
        ...
        internal override string IdPrefix => "RMFLI";
