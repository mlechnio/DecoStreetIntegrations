...
{
    public class ArtPol_IntegrationShoperRCCAC : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Rośliny / Kaktusy";

        private readonly string NamePart = "Rośliny / Kaktusy";
        ...
        internal override string IdPrefix => "RCCAC";
