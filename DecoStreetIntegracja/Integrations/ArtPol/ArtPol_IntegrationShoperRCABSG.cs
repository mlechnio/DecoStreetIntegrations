...
{
    public class ArtPol_IntegrationShoperRCABSG : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Abstrakcje geometryczne";

        private readonly string NamePart = "Abstrakcje geometryczne";
        ...
        internal override string IdPrefix => "RCABSG";
