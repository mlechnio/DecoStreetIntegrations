...
{
    public class ArtPol_IntegrationShoperRCPET : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Zwierzęta / Psy i koty";

        private readonly string NamePart = "Zwierzęta / Psy i koty";
        ...
        internal override string IdPrefix => "RCPET";
