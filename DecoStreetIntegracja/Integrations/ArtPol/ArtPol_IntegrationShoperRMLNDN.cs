...
{
    public class ArtPol_IntegrationShoperRMLNDN : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Pejzaż  nowoczesny";

        private readonly string NamePart = "Pejzaż nowoczesny";
        ...
        internal override string IdPrefix => "RMLNDN";
