...
{
    public class ArtPol_IntegrationShoperRCHRS : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Zwierzęta / Konie";

        private readonly string NamePart = "Zwierzęta / Konie";
        ...
        internal override string IdPrefix => "RCHRS";
