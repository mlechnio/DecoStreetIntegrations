...
{
    public class ArtPol_IntegrationShoperRMBAL : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Baletnice";

        private readonly string NamePart = "Baletnice";
        ...
        internal override string IdPrefix => "RMBAL";
