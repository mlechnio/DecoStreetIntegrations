...
{
    public class ArtPol_IntegrationShoperRMFIG : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Postacie";
        ...
        internal override string IdPrefix => "RMFIG";
