...
{
    public class ArtPol_IntegrationShoperRMFLR : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Kwiaty - Róże";

        private readonly string NamePart = "Kwiaty - Róże";
        ...
        internal override string IdPrefix => "RMFLR";
