...
{
    public class ArtPol_IntegrationShoperRCBFL : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Zwierzęta / Motyle i inne owady";

        private readonly string NamePart = "Zwierzęta / Motyle i inne owady";
        ...
        internal override string IdPrefix => "RCBFL";
