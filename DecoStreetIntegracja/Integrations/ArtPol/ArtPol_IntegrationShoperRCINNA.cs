...
{
    public class ArtPol_IntegrationShoperRCINNA : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Rośliny / Inne";

        private readonly string NamePart = "Rośliny / Inne";
        ...
        internal override string IdPrefix => "RCINNA";
