...
{
    public class ArtPol_IntegrationShoperRCBII : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Kwiaty / Inne";

        private readonly string NamePart = "Kwiaty / Inne";
        ...
        internal override string IdPrefix => "RCBII";
