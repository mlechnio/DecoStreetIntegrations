...
{
    public class ArtPol_IntegrationShoperRMPET : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Zwierzęta / Psy i koty";
        ...
        internal override string IdPrefix => "RMPET";
