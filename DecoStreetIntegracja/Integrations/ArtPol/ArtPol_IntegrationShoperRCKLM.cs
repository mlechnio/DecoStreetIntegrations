...
{
    public class ArtPol_IntegrationShoperRCKLM : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Kopie - Gustav Klimt";

        private readonly string NamePart = "Kopie - Gustav Klimt";
        ...
        internal override string IdPrefix => "RCKLM";
