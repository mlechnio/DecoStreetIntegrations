...
{
    public class ArtPol_IntegrationShoperRMVVG : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Kopie Mistrzów  / Vincent Van Gogh";

        private readonly string NamePart = "Kopie Mistrzów / Vincent Van Gogh";
        ...
        internal override string IdPrefix => "RMVVG";
