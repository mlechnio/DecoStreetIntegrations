...
{
    public class ArtPol_IntegrationShoperRMFTH : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Abstrakcje - różne / Pióra";

        private readonly string NamePart = "Abstrakcje - różne / Pióra";
        ...
        internal override string IdPrefix => "RMFTH";
