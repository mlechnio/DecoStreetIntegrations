...
{
    public class ArtPol_IntegrationShoperRCPLN : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Inne / Mapy i plany";

        private readonly string NamePart = "Inne / Mapy i plany";
        ...
        internal override string IdPrefix => "RCPLN";
