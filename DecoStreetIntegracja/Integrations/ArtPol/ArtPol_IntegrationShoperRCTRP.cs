...
{
    public class ArtPol_IntegrationShoperRCTRP : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Rośliny / Tropikalne liście i kwiaty";

        private readonly string NamePart = "Rośliny / Tropikalne liście i kwiaty";
        ...
        internal override string IdPrefix => "RCTRP";
