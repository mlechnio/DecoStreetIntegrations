...
{
    public class ArtPol_IntegrationShoperRCPOS : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Inne / Postery";

        private readonly string NamePart = "Inne / Postery";
        ...
        internal override string IdPrefix => "RCPOS";
