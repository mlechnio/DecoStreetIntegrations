...
{
    public class ArtPol_IntegrationShoperRMMAR : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Inne / Marine";

        private readonly string NamePart = "Inne / Marine";
        ...
        internal override string IdPrefix => "RMMAR";
