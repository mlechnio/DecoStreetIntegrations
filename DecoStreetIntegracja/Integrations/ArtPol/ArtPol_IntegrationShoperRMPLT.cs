...
{
    public class ArtPol_IntegrationShoperRMPLT : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Abstrakcje - różne / Motywy roślinne";

        private readonly string NamePart = "Abstrakcje - różne / Motywy roślinne";
        ...
        internal override string IdPrefix => "RMPLT";
