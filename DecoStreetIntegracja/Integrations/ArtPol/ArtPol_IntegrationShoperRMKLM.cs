...
{
    public class ArtPol_IntegrationShoperRMKLM : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Kopie - Gustav Klimt";
        ...
        internal override string IdPrefix => "RMKLM";
