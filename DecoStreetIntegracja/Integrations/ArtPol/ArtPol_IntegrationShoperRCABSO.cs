...
{
    public class ArtPol_IntegrationShoperRCABSO : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Abstrakcje organiczne";

        private readonly string NamePart = "Abstrakcje organiczne";
        ...
        internal override string IdPrefix => "RCABSO";
