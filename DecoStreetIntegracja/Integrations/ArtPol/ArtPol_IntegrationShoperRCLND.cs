...
{
    public class ArtPol_IntegrationShoperRCLND : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Pejzaż / Krajobraz";

        private readonly string NamePart = "Pejzaż / Krajobraz";
        ...
        internal override string IdPrefix => "RCLND";
