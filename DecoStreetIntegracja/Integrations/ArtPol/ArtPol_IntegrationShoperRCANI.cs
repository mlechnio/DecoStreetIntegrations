...
{
    public class ArtPol_IntegrationShoperRCANI : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Zwierzęta / Inne";

        private readonly string NamePart = "Zwierzęta / Inne";
        ...
        internal override string IdPrefix => "RCANI";
