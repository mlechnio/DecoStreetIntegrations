...
{
    public class ArtPol_IntegrationShoperRMFLN : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Kwiaty nowoczesne";

        private readonly string NamePart = "Kwiaty nowoczesne";
        ...
        internal override string IdPrefix => "RMFLN";
