...
{
    public class ArtPol_IntegrationShoperRMFLB : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Kwiaty - Bukiety";

        private readonly string NamePart = "Kwiaty - Bukiety";
        ...
        internal override string IdPrefix => "RMFLB";
