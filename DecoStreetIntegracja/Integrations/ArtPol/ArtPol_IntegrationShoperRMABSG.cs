...
{
    public class ArtPol_IntegrationShoperRMABSG : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Abstrakcje geometryczne";
        ...
        internal override string IdPrefix => "RMABSG";
