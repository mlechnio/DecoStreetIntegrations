...
{
    public class ArtPol_IntegrationShoperRMABSO : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / Abstrakcje organiczne";
        ...
        internal override string IdPrefix => "RMABSO";
