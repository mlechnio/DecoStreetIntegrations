...
{
    public class ArtPol_IntegrationShoperRCBRD : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Zwierzęta / Ptaki";

        private readonly string NamePart = "Zwierzęta / Ptaki";
        ...
        internal override string IdPrefix => "RCBRD";
