...
{
    public class ArtPol_IntegrationShoperRCNEW : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE /   NOWOŚCI";

        private readonly string NamePart = "Nowości";
        ...
        internal override string IdPrefix => "RCNEW";
