...
{
    public class ArtPol_IntegrationShoperRCABSP : IntegratorShoperBase
    {
        private readonly string BreadCrumbTrail = "Obrazy olejne ręcznie malowane / REPRODUKCJE / Abstrakcje - Postacie";
        ...
        internal override string IdPrefix => "RCABSP";
